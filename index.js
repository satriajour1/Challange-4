class Game {
    ...
    randomPick(gameArr) {
        ...
        let downloadTimer = setInterval(function(){
            timeleft -= 1
            this.comCliked = `com-${gameArr[timeleft].name}-${gameArr[timeleft].id}`
    ...
    hadleClick(id, name) {
        ...
        setTimeout(() => {
            ...
            this.comCliked = `com-${this-game[indexCom].name}-${this.game[indexCom].id}`
            this.comName = this-game[indexCom].name
            const elemCom = document.getElementById(this.comCliked)
